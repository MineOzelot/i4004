...
const enum e_opcode instruction_lookup[0x100] = {
		OP_NOP, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE, OP_ESIZE,
																										  OP_ESIZE, OP_ESIZE, OP_ESIZE, // 0x00 - 0x0f
		OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, OP_JCN, // 0x10 - 0x1F
		OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, OP_FIM, OP_SRC, // 0x20 - 0x2F
		OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, OP_FIN, OP_JIN, // 0x30 - 0x3F
		OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, OP_JUN, // 0x40 - 0x4F
		OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, OP_JMS, // 0x50 - 0x5F
		OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, OP_INC, // 0x60 - 0x6F
		OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, OP_ISZ, // 0x70 - 0x7F
		OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, OP_ADD, // 0x80 - 0x8F
		OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, OP_SUB, // 0x90 - 0x9F
		 OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD,  OP_LD, // 0xA0 - 0xAF
		OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, OP_XCH, // 0xB0 - 0xBF
		OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, OP_BBL, // 0xC0 - 0xCF
		OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, OP_LDM, // 0xD0 - 0xDF
		OP_WRM, OP_WMP, OP_WRR, OP_WPM, OP_WR0, OP_WR1, OP_WR2, OP_WR3, OP_SBM, OP_RDM, OP_RDR, OP_ADM, OP_RD0, OP_RD1, OP_RD2, OP_RD3, // 0xE0 - 0xEF
		OP_CLB, OP_CLC, OP_IAC, OP_CMC, OP_CMA, OP_RAL, OP_RAR, OP_TCC, OP_DAC, OP_TCS, OP_STC, OP_DAA, OP_KBP, OP_DCL, OP_ESIZE, OP_ESIZE // 0xF0 - 0xFF
};
